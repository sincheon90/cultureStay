package com.abcde.cultureStay.Config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer{
	...
	// private final ChatHandler chatHandler;
		...
		public void registerStompEndpoints(StompEndpointRegistry registry) {
			registry.addEndpoint("/stomp/chat").setAllowedOriginPatterns("http://localhost:3333").withSockJS();
			registry.addEndpoint("/stomp/alarm").setAllowedOriginPatterns("http://localhost:3333").withSockJS();
		}
		/*
