...
CREATE TABLE Users(
	...
	profilePic	varchar2(255)	    NULL,        --프사
    verified    varchar2(1) CHECK(verified IN  ('0','1'))--본인인증 여부
); --verified 디폴트값 넣어주기

--유저 좋아요,북마크, 최근방문 프로그램 :  추천시 사용
CREATE TABLE Interests(     
    	userid	    varchar2(255)	    primary key references Users(userid), 
...
CREATE TABLE Program (
	...
	userid	    varchar2(255)	references Users(userid), 
...
CREATE TABLE Review (
	...
	customerID	    varchar2(255)		references Users(userid), 
	hostID	        varchar2(255)		references Users(userid), 
	reviewerID	    varchar2(255)		references Users(userid), 
